...
<body>
    ...
    <div class="container my-4">
        <div class="row featurette my-4 d-flex justify-content-center align-item-center">
            <div class="col-md-7">
    ...
    <div class="container my-4">
        <div class="row featurette my-4 d-flex justify-content-center align-item-center">
            <div class="col-md-7 order-md-2">
                <h2 class="featurette-heading">we started iCoder 1877. <span class="text-muted">It’ll blow your
                        mind.</span></h2>
                <p class="lead">Some great placeholder content for the first featurette here. Imagine some exciting
                    prose here.</p>
            </div>
    ...
    <div class="container my-4">
        <div class="row featurette my-4 d-flex justify-content-center align-item-center">
            <div class="col-md-7">
                <h2 class="featurette-heading">all iCoder. <span class="text-muted">It’ll blow your
                        mind.</span></h2>
                <p class="lead">Some great placeholder content for the first featurette here. Imagine some exciting
                    prose here.</p>
            </div>
